...
fps = 40
#logo of our team - innoVATorS
logo = pygame.image.load('res\logo1.jpg').convert_alpha()
...
def welcome():
    #Welcome page audio 1
    pygame.mixer.music.load('res\helloriders.mp3')                        
    pygame.mixer.music.play()  
    exit_game = False
    while not exit_game:
        #welcome page image
        welcimg = pygame.image.load('res\welcome.jpg').convert_alpha()
